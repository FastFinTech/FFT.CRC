...
namespace FFT.CRC
{
    ...
    /// of a stream of data as each new data segment becomes available.
    /// </summary>
    /// <remarks>
    /// This struct MUST BE INITIALIZED before use with the <see cref="Initialize"/> method,
    /// or you can obtain an already-initialized value with the static <see cref="CreateInitialized"/> method.
    /// </remarks>
    public struct CRC32Builder
    {
        ...
        /// Always initialize a <see cref="CRC32Builder"/> with this method before use, or obtain an initial value
        /// via the static <see cref="CreateInitialized"/> method.
        /// </summary>
        ...
        /// <summary>
        /// Creates an initialized <see cref="CRC32Builder"/>.
        /// </summary>
